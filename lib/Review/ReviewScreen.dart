                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            getGraph(
                              ...
                              country: selectedCountry == 'global' ? null : selectedCountry,
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              ...
              colors: [Colors.teal[600], Colors.blue[700]],
            ),
          ),
          child: Column(
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) => strengths[index],
                physics: ClampingScrollPhysics(),
                shrinkWrap: true,
              )
            ],
          ...
          child: Column(
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) => averageCategories[index],
                physics: ClampingScrollPhysics(),
                shrinkWrap: true,
              )
            ],
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              ...
              colors: [Colors.red[900], Colors.pink[900]],
            ),
          ),
          child: Column(
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) => weaknesses[index],
                physics: ClampingScrollPhysics(),
                shrinkWrap: true,
              )
            ],
  ...
  void ifEmptyAddNone(List<Widget> list) {
    if (list.length == 1) {
      ...
      list.add(
        Row(
          children: [
            Text('None', style: inputTextStyle),
            Text(''),
          ],
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
        ),
